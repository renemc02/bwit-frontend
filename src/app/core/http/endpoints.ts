...
export const API = {
  ...
  facturas:        { base: `${B}/facturas`, byId: (id: number) => `${B}/facturas/${id}`, anular: (id: number) => `${B}/facturas/${id}/anular`, pagos: `${B}/facturas/pagos`, aprobar: (id: number) => `${B}/facturas/${id}/aprobar`, historial: (id: number) => `${B}/facturas/${id}/historial`, notasCredito: (id: number) => `${B}/facturas/${id}/notas-credito`, itemsCreditables: (id: number) => `${B}/facturas/${id}/items-creditables` },
